...
if($_POST) {
    ...
    if(mail($recipient, $email_subject, $email_body, $headers)) {
        echo "<p>Dear $visitor_name, thank you for getting in touch! We appreciate you contacting CFM. We will get back in touch with you soon. Have a great day!</p>";
    } else {
