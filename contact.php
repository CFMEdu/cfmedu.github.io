...
<html lang="en-US">
<head>
	<title>Site Map | CFM Educational Services</title>
  <meta charset="utf-8">
...
<body>
			...
			<div class="navMenu">
				<ul>
					...
					<li><a href="berkeley.php" class="navDeco">UC Berkeley</a>
						<ul class="navDropdown">
							<li><a href="atdp.php">ATDP</a></li>
							<li><a href="lsi.php">LSI</a></li>
							<li><a href="ssd.php">SSD</a></li>
							<li><a href="walex.php">WALEX</a></li>
	...
	<main>
		...
		<!-- ====== Site Map ======  -->
		<section id="sitemap" class="padding-0-5">
			<div class="marginTop marginBottom">
				<h2><a href="index.php">Home</a></h2>
				<h2><a href="about.php">About</a></h2>
					<ul class="firstLevel">
						<li class="flex100 flex50-sm flex30-md flex20-lg"><a href="about.php#about">About CFM</a></li>
						<li class="flex100 flex50-sm flex30-md flex20-lg"><a href="about.php#mission">Our Mission</a></li>
						<li class="flex100 flex50-sm flex30-md flex20-lg"><a href="about.php#testimonials">Testimonials</a></li>
					</ul>
				<h2><a href="berkeley.php">UC Berkeley</a></h2>
					<ul class="firstLevel">
						<li class="flex100 flex50-sm flex30-md flex20-lg">
							<a class="flex35" href="atdp.php">ATDP</a>
							<a class="flex65" href="atdp-courses.php">Courses</a>
						</li>
						<li class="flex100 flex50-sm flex30-md flex20-lg">
							<a class="flex35" href="lsi.php">LSI</a>
							<a class="flex65" href="lsi-courses.php">Courses</a>
						</li>
						<li class="flex100 flex50-sm flex30-md flex20-lg">
							<a class="flex35" href="ssd.php">SSD</a>
							<a class="flex65" href="https://classes.berkeley.edu/" target="_blank">Courses <i class="fa fa-external-link" aria-hidden="true"></i></a>
						</li>
						<li class="flex100 flex50-sm flex30-md flex20-lg">
							<a class="flex35" href="walex.php">WALEX</a>
							<a class="flex65 noLink">Courses</a>
						</li>
						<li class="flex100 flex50-sm flex30-md flex20-lg">
							<a class="flex35" href="wfcc.php">WFCC</a>
							<a class="flex65" href="wfcc-courses.php">Courses</a>
						</li>
					</ul>
				<h2><a href="silicon-valley-school-district.php">Silicon Valley School District</a></h2>
					<ul class="firstLevel">
						<li class="flex100 flex50-sm flex30-md flex20-lg">
							<a class="flex35" href="ofk.php">OFK</a>
							<a class="flex65" href="ofk.php#ofk-curriculum">Courses</a>
						</li>
					</ul>
				<h2><a href="contact.php">Contact Us</a></h2>
				<h2><a href="sitemap.php">Site Map (this page)</a></h2>
			</div>
		</section>   <!-- ====== End of Site Map ======  -->
	...
	<footer>
		<div class="flexRow padding-0-5">
			...
			<div class="flexHalf footerRow footerBox">
			    ...
			    <figcaption><a href="atdp.php">ATDP</a></figcaption>
			    <ul>
		        <li><a href="atdp-courses.php"><i class="fa fa-angle-right" aria-hidden="true"></i> Courses</a></li>
		        <li><a href="atdp.php#atdp-gallery"><i class="fa fa-angle-right" aria-hidden="true"></i> Gallery</a></li>
			    </ul>
			  </figure>
				<figure class="progBox lsi montserrat">
			    <figcaption><a href="lsi.php">LSI</a></figcaption>
			    <ul>
		        <li><a href="lsi-courses.php"><i class="fa fa-angle-right" aria-hidden="true"></i> Courses</a></li>
		        <li><a href="lsi.php#lsi-gallery"><i class="fa fa-angle-right" aria-hidden="true"></i> Gallery</a></li>
			    </ul>
			  </figure>
				<figure class="progBox wfcc montserrat">
			    <figcaption><a href="wfcc.php">WFCC</a></figcaption>
			    <ul>
		        <li><a href="wfcc-courses.php"><i class="fa fa-angle-right" aria-hidden="true"></i> Courses</a></li>
		        <li><a class="noLink"><i class="fa fa-angle-right" aria-hidden="true"></i> Gallery</a></li>
			    </ul>
			  </figure>
				<figure class="progBox ssd montserrat">
			    <figcaption><a href="ssd.php">SSD</a></figcaption>
			    <ul>
		        ...
		        <li><a href="ssd.php#ssd-gallery"><i class="fa fa-angle-right" aria-hidden="true"></i> Gallery</a></li>
			    </ul>
			  </figure>
			    ...
			    <figcaption><a href="walex.php">WALEX</a></figcaption>
			    <ul>
