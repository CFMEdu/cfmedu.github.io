...
<html lang="en-US">
<head>
	<title>WFCC Courses | CFM Educational Services</title>
  <meta charset="utf-8">
	...
	<main>
      ...
      <div id="checkDiv"></div>
		  <div class="subNavigation">
		    <a href="#essay-personal-statement">Essay/Personal Statement</a>
	      <a href="#research-writing">Research Writing</a>
	      <a href="#journalism">Journalism</a>
		    <a href="#writing-for-communication">Writing for Communication</a>
	    </div>
		</section>  <!-- ====== End of Subnavigation ======  -->


		<!-- ====== Essay/Personal Statement ======  -->
		<section id="essay-personal-statement">
			...
			<section class="padding-5-0">
				<span class="crimsonText textCenter font-S displayBlock">Subject I (Week 1)</span>
				<h2 class="crimsonText textCenter font-M fontWeight700">Essay/Personal Statement</h2>
				<div class="panel">
					<div class="content linedPaper-w">
						<div>
							<p>
					...
					<figure class="landscape">
						<img src="images/wfcc/courses/essay-personal-statement.jpg" alt="WFCC Essay/Personal Statement Course"/>
					</figure>				
				</div>
			</section>
		</section>  <!-- ====== End of Essay/Personal Statement ======  -->
		...
		<section id="research-writing">
			...
			<section class="padding-5-0">
				<span class="crimsonText textCenter font-S displayBlock">Subject II (Week 2)</span>
				<h2 class="crimsonText textCenter font-M fontWeight700">Research Writing</h2>
				<div class="panel">
					<div class="content linedPaper-w">
						<div>
							<p>
					...
					<figure class="landscape">
						<img src="images/wfcc/courses/research-writing.jpg" alt="WFCC Research Writing Course"/>
					</figure>				
				</div>
			</section>
		</section>  <!-- ====== End of Research Writing ======  -->
		...
		<section id="journalism">
			...
			<section class="padding-5-0">
				<span class="crimsonText textCenter font-S displayBlock">Subject III (Week 3)</span>
				<h2 class="crimsonText textCenter font-M fontWeight700">Journalism</h2>
				<div class="panel">
					<div class="content linedPaper-w">
						<div>
							<p>
					...
					<figure class="landscape">
						<img src="images/wfcc/courses/journalism.jpg" alt="WFCC Journalism Course"/>
					</figure>				
				</div>
			</section>
		</section>  <!-- ====== End of Journalism ======  -->


		<!-- ====== Writing for Communication ======  -->
		<section id="writing-for-communication" class="marginBottom">
			<div class="dotLine padding-5-0">
			  <span class="dotLineStar"></span>
			  <span class="dotLineStar"></span>
			  <span class="dotLineStar"></span>
			...
			<section class="padding-5-0">
				<span class="crimsonText textCenter font-S displayBlock">Subject IV (Week 4)</span>
				<h2 class="crimsonText textCenter font-M fontWeight700">Writing for Communication</h2>
				<div class="panel">
					<div class="content linedPaper-w">
						<div>
							<p>
					...
					<figure class="landscape">
						<img src="images/wfcc/courses/writing-for-communication.jpg" alt="WFCC Writing for Communication Course"/>
					</figure>				
				</div>
			</section>
		</section>  <!-- ====== End of Writing for Communication ======  -->
